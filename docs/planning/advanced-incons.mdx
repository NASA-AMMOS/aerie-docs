...
# Advanced - Incons from Prior Simulation
...
The instructions on this page are designed to work with the example Mission Model changes provided [here](../../mission-modeling/advanced-incons-from-file).
...
<figure>
  <img alt="Aerie UI - Dropdown Menu Highlighting GraphQL Console Option" src={gqlDropdown} style={{ maxHeight: '50vh' }}/>
...
<figure>
  ...
  <figcaption>Figure 1: Dropdown Menu Highlighting Gateway Option</figcaption>
</figure>
