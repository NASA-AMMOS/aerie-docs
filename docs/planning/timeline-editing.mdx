...
<figure>
  ...
  />
  <figcaption>Figure 3: Aerie UI Timeline Discrete Options Editor - Manage Activity and Event Rendering</figcaption>
</figure>
...
<figure>
  <img
    ...
    style={{ maxHeight: '100%', width: '100%' }}
  />
  <figcaption>Figure 4: Aerie UI Timeline Layer Options Display Mode</figcaption>
</figure>
