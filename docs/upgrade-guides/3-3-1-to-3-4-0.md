...
```
See [the mission model template](https://github.com/NASA-AMMOS/aerie-mission-model-template/blob/8bc56fe9f47b2494ab655855fe7d7ef8fca6e1ae/scheduling/build.gradle) for example and [this Github issue](https://github.com/junit-team/junit5/issues/4374#issuecomment-2704880447) for more info.
