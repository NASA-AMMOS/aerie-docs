...
:::caution
**Aerie v2.9.0** is an **Upgrade Checkpoint** version - if you are upgrading from an _earlier_ version of Aerie directly to a _later_ one, you **must first** upgrade to `v2.9.0` and follow the instructions below before continuing to a later version. See the [Upgrade Process](/deployment/upgrade-process/) guide for more details
:::
