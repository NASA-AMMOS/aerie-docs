...
[//]: # (Examples of the two different `Group By` modes, as well as visibility enable/disable can be seen in the [Plan]&#40;../../../planning/external-events/introduction/#plan&#41; section of the main External Events documentation.)
