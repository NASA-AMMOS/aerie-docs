...
Go ahead and leave the `Derivation Group` as `DemoType Default`. To demonstrate Derivation Groups' functionality, we will reupload one of these files under a different Derivation Group to demonstrate the effects of the derivation operation.
