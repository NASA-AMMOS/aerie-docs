...
# Upload the External Source & Event Type Schema
First, we must upload the schema we created for the External Source Type & the two External Event Types. Assuming you have deployed an instance of Aerie, navigate to the External Sources page:
...
Having created our types, we are now able to upload the External Source. Navigate to the External Sources page:
...
For more information on Derivation Groups, refer to the [External Events](../../../planning/external-events/introduction) documentation underneath the `Derivation` section!
