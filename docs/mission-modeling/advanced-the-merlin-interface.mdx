...
Merlin is based on 
[Blackbird[(https://trs.jpl.nasa.gov/handle/2014/52245),
providing Java libraries for defining activities and resources.  
The codebase has diverged from Blackbird's, but they share the same 
approach of simulating an activity by executing its Java 
implementation and leveraging Java's full programming language for
a procedural specification of system behavior.
