...
Users should use the `/uploadExternalSourceEventTypes` route in `aerie-gateway` to upload their "types" file.
...
Users should use the `uploadExternalSource` route in `aerie-gateway` to upload their External Sources file.
