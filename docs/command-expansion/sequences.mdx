...
Aerie currently does not support time sorting commands from multiple activities.
The commands will be added to the sequence in the order of activity start times.
