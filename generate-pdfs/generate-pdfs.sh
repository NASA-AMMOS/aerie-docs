...
# npx docusaurus-prince-pdf -u http://localhost:3000/aerie-docs/introduction/
# This will output a .txt index of all files under aerie-docs/introduction.

# Aerie API
npx docusaurus-prince-pdf \
  --pdf-only \
  -u http://localhost:3000/aerie-docs/api/introduction/ \
...
npx docusaurus-prince-pdf \
  --pdf-only \
  -u http://localhost:3000/aerie-docs/overview/concept-of-operations/ \
...
npx docusaurus-prince-pdf \
  --pdf-only \
  -u http://localhost:3000/aerie-docs/mission-modeling/introduction/ \
...
npx docusaurus-prince-pdf \
  --pdf-only \
  -u http://localhost:3000/aerie-docs/category/deployment/ \
...
npx docusaurus-prince-pdf \
  --pdf-only \
  -u http://localhost:3000/aerie-docs/overview/software-design-document/ \
...
npx docusaurus-prince-pdf \
  --pdf-only \
  -u http://localhost:3000/aerie-docs/introduction/ \
